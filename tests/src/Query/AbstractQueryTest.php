...
class QueryTest extends AbstractTestCase
{
     ...
     * @covers CL\Atlas\Query\AbstractQuery::addChildrenObjects
     */
    public function testAddChildrenObjects($array, $argument, $calls)
    {
        ...
        $query->addChildrenObjects(AbstractQuery::TABLE, $array, $argument, array($class, 'testMethod'));

        $this->assertEquals($query->getChild(AbstractQuery::TABLE), $expected);
    }
