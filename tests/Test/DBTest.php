<?php namespace Openbuildings\Cherry\Test;
...
class DBTest extends TestCase {
	...
	public function testSelect()
	{
		...
		$this->assertInstanceOf('Openbuildings\Cherry\Query\SelectQuery', $select);
	...
	public function testUpdate()
	{
		...
		$this->assertInstanceOf('Openbuildings\Cherry\Query\UpdateQuery', $update);
	...
	public function testDelete()
	{
		...
		$this->assertInstanceOf('Openbuildings\Cherry\Query\DeleteQuery', $delete);
	...
	public function testInsert()
	{
		...
		$this->assertInstanceOf('Openbuildings\Cherry\Query\InsertQuery', $query);
